...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4">
        <a href="{{ route('admin.maintenance.index') }}" class="text-muted me-2">
          <i class="bx bx-arrow-back"></i>
        </a>
        <span class="text-muted fw-light">Forms /</span> Maintenance
      </h4>
      <!-- Basic Layout -->
      <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
              <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Perpanjangan Paket</h5>
                <small class="text-muted float-end">Silakan input data perpanjangan</small>
              </div>
                    ...
                    <div class="mb-3">
                      ...
                      <div class="mb-3"  style="margin-top: 8px">
                        ...
                        <select class="form-select data-perusahaan" id="orderSelect" name="id_order">
                            {{-- <option selected>Pilih ID Order Yang Ingin Diperpanjang</option> --}}
                            <option selected>{{ $order->id_order }}</option>
                     ...
                     <div style="margin-right: 10px;">
                        ...
                        <input type="date" class="form-control" id="tanggal_langganan_datepicker" name="tanggal_langganan" value="{{ $order->tanggal_langganan }}">
                        </div>
                        <div>
                         <label class="form-label" for="due-date" style="font-size: 12px;">Tanggal Habis</label><br>
                            <input type="date" id="tanggal_habis_datepicker" name="tanggal_habis" class="form-control" value="{{ $order->tanggal_habis }}"> </div>
                            </div>
                            </div>
                  <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <div class="form-text">Anda dapat menggunakan huruf, angka, dan titik</div>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="ppn-paketSelect" placeholder="Masukkan total keseluruhan" name="ppn"/>
                  </div>
                  <div class="mb-3">
