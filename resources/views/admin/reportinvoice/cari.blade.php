    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a href="{{ route('admin.reportinvoice.index') }}">Report Invoice</a>
          </li>
          <li class="breadcrumb-item">
            <a href="">Laporan</a>
          </li>
    ...
    <div class="card">
      <h4 class="card-header">
        <div class="alert alert-primary">
            <p><span class="font-weight-bold">Laporan Invoice Tanggal: {{ $dari }}  Sampai : {{ $sampai }} </span></p>
        </div>
      </h4> 
      <div class="card-body">
           <!-- Responsive Table -->
           <div class="card">
            <h5 class="cart-header">Filter Report Order</h5>
             ...
             <!-- Filter Tanggal -->
             <form id="filterForm" method="GET" action="{{ route('admin.reportinvoice.cari') }}" class="row mb-4">
              <div class="col-md-3">
              ...
              <div class="col-md-3 d-flex float-end">
                ...
                <a href="{{ route('admin.reportinvoice.export_pdf') }}" class="btn btn-danger float-end" style="margin-left: 20px"><i class="fa-solid fa-file-pdf"></i></a>
              </div>
          </form>
              ...
              <table class="table" id="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="">{{ $item->nama_perusahaan }}</td>
                    <td class="">{{ $item->formatRupiah('total') }}</td>
                    <td class="">{{ $item->tanggal_langganan }}</td>
                    <td class="">{{ $item->tanggal_langganan }}</td>
                    <td class="">
                      <div class="d-flex flex-column">
                        <a href="{{ route('admin.reportinvoice.show', urlencode($item->id_order)) }}" class="btn btn-outline-info btn-sm mb-2">
