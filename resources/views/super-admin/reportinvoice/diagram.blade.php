...
<div class="container mt-5">
    <h4 class="fw-bold py-3 mb-4">
        <a href="{{ route('super-admin.reportinvoice.indexSuperAdmin') }}" class="text-muted me-2">
        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-3 d-flex align-items-end justify-content-end">
                    <a href="{{ route('super-admin.reportinvoice.diagram_printSuperAdmin', ['dari' => $dari, 'sampai' => $sampai]) }}"
