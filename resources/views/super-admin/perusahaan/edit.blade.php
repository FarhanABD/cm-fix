...
<div class="content-wrapper">
            ...
            <form action="{{ route('super-admin.perusahaan.update',$perusahaans->id) }}" method="POST" enctype="multipart/form-data">
              @csrf
              @method('PUT')
              <!-- Basic Layout -->
              <div class="row">
                 ...
                 <div class="card mb-4">
                   ...
                   <div class="card-body">
                       <div class="mb-3">
                         ...
                         <input type="text" class="form-control" id="basic-default-company" name="nama_perusahaan" placeholder="Masukkan nama perusahaan" value="{{ $perusahaans->nama_perusahaan }}"/>
                       </div>
                       <div class="mb-3">
                         <label class="form-label" for="basic-default-email">Email</label>
                         <div class="input-group input-group-merge">
                           <input
                             value="{{ $perusahaans->email }}"
                             type="text"
                       ...
                       <div class="mb-3">
                        ...
                        <input  type="text" name="jenis_perusahaan" class="form-control" id="basic-default-company" placeholder="Masukkan jenis perusahaan" value="{{ $perusahaans->jenis_perusahaan }}" />
                      </div>
                       <div class="mb-3">
                         <label class="form-label" for="basic-default-company">Alamat</label>
                         <input  type="text" name="alamat" class="form-control" id="basic-default-company" placeholder="Masukkan alamat perusahaan" value="{{ $perusahaans->alamat }}" />
                       </div>
                       <div class="mb-3">
                       ...
                       <div class="mb-3">
                         ...
                         <input value="{{ $perusahaans->keterangan }}" type="text" name="keterangan" class="form-control" id="basic-default-company" placeholder="Masukkan keterangan perusahaan" />
                       </div>
                       <div class="mb-3">
                         <label class="form-label" for="basic-default-company">Nama Website</label>
                         <input value="{{ $perusahaans->nama_website }}" type="text" name="nama_website" class="form-control" id="basic-default-company" placeholder="Masukkan nama website" />
                       </div>
