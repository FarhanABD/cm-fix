...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4">
        <a href="{{ route('super-admin.invoice.indexSuperAdmin') }}" class="text-muted me-2">
      ...
      <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
              ...
              <form action="{{ route('super-admin.invoice.updateSuperAdmin', $invoice->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
              <div class="card-body">
                    <div class="mb-3">
