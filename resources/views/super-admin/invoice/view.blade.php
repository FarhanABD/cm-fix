 ...
 <div class="container-fluid" style="margin-top: 24px"> <!-- Menggunakan container-fluid untuk lebar penuh -->
    <div class="card">
        ...
        <div class="table-responsive text-nowrap">
            ...
            {{-- <div class="card-footer bg-white" style="margin-bottom: 8px">
                <h5>Keterangan : {{ $item->item_desc }}</h5>
            </div> --}}
            <div class="card-footer bg-white" style="margin-top: 8px">
                <a href="{{ route('super-admin.invoice.indexSuperAdmin') }}" class="btn btn-sm btn-outline-warning"><i class="fas fa-caret-left"></i> Kembali</a>
            </div>
        </div>
    </div>
</div>
