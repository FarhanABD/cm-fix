...
class AdminController extends Controller
{
    public function dashboard()
    {
        ...
        return view('admin.dashboard', compact('maintenancesCount', 'totalCustomer', 'orderCount', 'layananCount', 'paketCount', 'latestInvoices', 'pendapatan','hasOrdersNearExpiry','maintenancesGetData','paketSilverCount','paketGoldCount','paketPlatinumCount','paketCustomCount','paketBrandingCount','invoiceCount'));
    }
